...
export function ShelfMosaico() {
  ...
  return (
    <div className="px-4  lg:max-w-container lg:m-auto">
      <div className="flex justify-between items-start gap-3 mb-5">
        ...
        <Link
          href={""}
          className="h-12 w-27 flex items-center gap-1.5 py-2.5 px-3.5 border border-gray-200 rounded-full "
        >
      ...
      >
        <CarouselContent>
          {productChunks.map((item: SplitArrayProducts[], i: number) => (
            <CarouselItem key={i} className="md:basis-1/2 lg:basis-2/5">
        ...
        <CarouselPrevious className="hidden lg:flex lg:left-0 lg:top-52 bg-[#E5E7EB]" />
        <CarouselNext className="hidden lg:flex lg:right-0 lg:top-52 bg-[#E5E7EB]" />
      </Carousel>
    </div>
  );
}
